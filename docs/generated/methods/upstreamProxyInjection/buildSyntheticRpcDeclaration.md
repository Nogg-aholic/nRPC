# upstreamProxyInjection.buildSyntheticRpcDeclaration

> **HTTP:** `POST /api/upstreamProxyInjection/buildSyntheticRpcDeclaration` | **Type:** `async function upstreamProxyInjection.buildSyntheticRpcDeclaration(definition: SyntheticRpcSurfaceLike, options?: BuildSyntheticRpcDeclarationOptions): Promise<string>` | **Location:** [`../../src/index.ts:158`](../../src/index.ts:158)

## Signature

```typescript
async function upstreamProxyInjection.buildSyntheticRpcDeclaration(definition: SyntheticRpcSurfaceLike, options?: BuildSyntheticRpcDeclarationOptions): Promise<string>
```
