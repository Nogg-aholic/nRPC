# upstreamProxyInjection.asUpstreamProxyInjectionDefinition

> **HTTP:** `POST /api/upstreamProxyInjection/asUpstreamProxyInjectionDefinition` | **Type:** `async function upstreamProxyInjection.asUpstreamProxyInjectionDefinition(definition: SyntheticRpcSurfaceLike): Promise<UpstreamProxyInjectionDefinition>` | **Location:** [`../../src/index.ts:157`](../../src/index.ts:157)

## Signature

```typescript
async function upstreamProxyInjection.asUpstreamProxyInjectionDefinition(definition: SyntheticRpcSurfaceLike): Promise<UpstreamProxyInjectionDefinition>
```
