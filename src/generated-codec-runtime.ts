...
function generatedCodecLiteralToPrimitiveShape(
  shape: Extract<GeneratedCodecShape, { kind: "literal" }>,
): GeneratedCodecShape {
...
function isGeneratedCodecTypedArrayInstance(
  value: unknown,
  arrayType: GeneratedCodecTypedArrayKind,
...
function isGeneratedCodecShapeMatch(
  value: unknown,
  shape: GeneratedCodecShape,
): boolean {
  switch (shape.kind) {
    ...
    case "optional":
      return (
        value === undefined || isGeneratedCodecShapeMatch(value, shape.inner)
      );
    case "date":
    ...
    case "union":
      return shape.variants.some((variant) =>
        isGeneratedCodecShapeMatch(value, variant),
      );
    case "discriminated-union":
      return (
        value !== null &&
        typeof value === "object" &&
        shape.discriminator in (value as Record<string, unknown>)
      );
  }
}
