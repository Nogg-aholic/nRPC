...
export interface CreateServiceFetchHandlerOptions<TService> {
  ...
  syntheticRouteManifest?: HttpRouteManifest;
  syntheticRoutesEnabled?: boolean;
  syntheticJsonEnvelope?: boolean;
  syntheticJsonResponseFactory?: SyntheticJsonResponseFactory;
  syntheticBinaryResponseFactory?: SyntheticBinaryResponseFactory;
